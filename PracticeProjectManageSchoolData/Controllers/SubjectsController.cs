...
using PracticeProjectManageSchoolData.Models;

namespace PracticeProjectManageSchoolData.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subject != null ? 
                          ...
                          Problem("Entity set 'SchoolContext.Subject'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolContext.Subject'  is null.");
            }
            var subject = await _context.Subject.FindAsync(id);
            if (subject != null)
            {
